...
class session
{
    ...
    {
        $sql = "INSERT INTO `" . DB_PREFIX . "order_details`( `user_id`) VALUES ('" . $_SESSION['id'] . "')";
        DataBase::$conn->query($sql);
    }
    function createOrder($productId, $price)
    {
        $sql = "SELECT  * FROM `" . DB_PREFIX . "order_details` WHERE `user_id` = " . $_SESSION['id'] . " 
        ...
        $sql = "INSERT INTO `" . DB_PREFIX . "order_items`( `order_details_id`, `product_id`, `quantity`, `total_per_unit`) VALUES ('" . $OrderSessionId . "','" . $productId . "','1','" . $price . "')";
        DataBase::$conn->query($sql);
    }
}
