                ...
                <div class="cards__card card">
                    <div class="wrap">
                        ...
                        if (isset($_POST['password']) and isset($_POST['username']) and isset($_POST['last_name']) and isset($_POST['first_name']) and isset($_POST['password_again']) and isset($_POST['phone']) and isset($_POST['email'])) {
                            if (empty($_POST['password'])  or empty($_POST['username']) or empty($_POST['first_name']) or empty($_POST['last_name']) or  empty($_POST['phone']) or empty($_POST['email'])){ $msg .= "fill all the boxes!";}
                            if (empty($_POST['password_again'])) {$msg .= "you must confirm your password!";}
                            if ($_POST['password'] != $_POST['password_again']){ $msg .= "your password and confirmed password does not match!";}
                            if (empty($msg)) {
                                $sql = "INSERT INTO `user` ( `username`, `user_password`, `first_name`, `last_name`, `phone`, `email`) VALUES ('" . $_POST['username'] . "','" . $_POST['password'] . "','" . $_POST['first_name'] . "','" . $_POST['last_name'] . "','" . $_POST['phone'] . "','" . $_POST['email'] . "');";
                        ...
                        <form method="post">
                            ...
                            <br>
                            <input type="submit" value="submit" class="submit-btn" onclick="Allert()">
